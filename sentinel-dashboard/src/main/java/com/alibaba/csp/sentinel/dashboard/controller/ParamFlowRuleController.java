...
public class ParamFlowRuleController {
    ...
    @Autowired
    @Qualifier("paramFlowNacosProvider")
    private DynamicRuleProvider<List<ParamFlowRuleEntity>> provider;
    @Autowired
    @Qualifier("paramFlowNacosPublisher")
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> paramFlowRuleEntities = provider.getRules(app);
            return Result.ofSuccess(repository.saveAll(paramFlowRuleEntities));
